...
const content = {
    ...
    // Hero Section
    hero_title: {
        en: 'Tianjin Huanchen Technology',
        zh: '欢晨科技'
    },
    hero_subtitle: {
    ...
    hero_tagline: {
        en: 'Leading the future of tech, creating infinite possibilities',
        zh: '引领科技未来, 创造无限可能'
    },
    hero_main_title_1: {
        en: 'Professional Technology',
        zh: '专业的科技解决方案提'
    },
    hero_main_title_2: {
        en: 'Solutions Provider',
        zh: '供商'
    },
    hero_subtitle_new: {
    ...
    values_integrity_title: {
        en: 'Integrity and Openness',
        zh: '诚信开放'
    },
    ...
    partner_tianyi_cloud: {
        en: 'Tianyi Cloud',
        zh: '天翼云'
    },
    partner_siliconcloud: {
        en: 'Silicon Flow',
        zh: '硅基流动'
    },
    // Contact Section
    ...
    footer_company_name: {
        en: 'Tianjin Huanchen Technology Co., Ltd.',
        zh: '天津欢晨科技有限公司'
    },
    footer_rights: {
...
function LanguageProvider({ children }) {
    ...
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LanguageProvider.useCallback[t]": (key)=>{
            ...
            const { content } = __turbopack_context__.r("[project]/src/lib/content.ts [app-client] (ecmascript)");
...
_s(LanguageProvider, "4Kah8aOa6TOofaTaXg0USGPO0Cc=");
_c = LanguageProvider;
var _c;
...
//# sourceMappingURL=src_e2030fe6._.js.map